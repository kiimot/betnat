...
//logoLiverpool = new Image ( );
//logoLiverpool.src = "./assets/img/liverpool.png";
//$f1="./assets/img/liverpool.jpg";
...
$lakersVSceltics = new Basquet("B01","Basquet","13/04/2022 04:00","Los Angeles Lakers","Boston Celtics","lakers.png","celtics.png",2.50,1.35);
$warriorsVSclippers = new Basquet("B02","Basquet","16/04/2022 01:00","Golden State Warriors","Los Angeles Clippers","warriors.png","clippers.png",1.70,1.95);
